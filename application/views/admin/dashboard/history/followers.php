						...
						<div style="margin-bottom: 10px; text-align: center; font-size: 0.9em; color: #666;">
							<?php if($followers_win_stats['startdate'] || $followers_win_stats['lastdate']): ?>
								...
								<?php if($followers_win_stats['lastdate']): ?>
									<strong>Last Draw Date:</strong> <?php echo date('l F j, Y', strtotime($followers_win_stats['lastdate'])); ?> (<?php echo $followers_win_stats['total_winners']; ?> draw<?php echo $followers_win_stats['total_winners'] != 1 ? 's' : ''; ?>)
								<?php else: ?>

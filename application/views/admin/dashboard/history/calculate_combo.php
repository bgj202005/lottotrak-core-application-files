							...
							<div class = "col-12" style = "margin-top:2em;">
								...
								<div class="form-group form-group-lg row">
									<?php $extra = array('class' => 'btn btn-primary btn-lg btn-info d-flex', 
										...
										$js = "location.href='".base_url()."admin/history/'";
										$attributes = array(
										'class' 	=> "btn btn-primary btn-lg btn-info",
										'onClick' 	=> "$js", 
										'style' 	=> "padding:10px; display: block; margin:20px 20px;"
									);
										echo form_button('history_list', 'Back to the Lottery Wins History List', $attributes); 

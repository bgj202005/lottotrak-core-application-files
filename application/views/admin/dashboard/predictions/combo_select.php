				...
				<div class="col-12">
					<div class="card mt-3 tab-card">
						...
						<div class="tab-content" id="myTabContent">
							...
							<?php echo form_open(base_url().'admin/predictions/combo_statistics/'.$lottery->id); ?>
												...
												<tr>    
													...
													<div class="form-check">
														...
														echo '<td>' . form_radio('file', $file->file_name, $is_checked, [
															...
															'id' => 'Radio_' . $file->id,
															'style' => 'margin-left:1px; margin-right:5px; margin-top:10px;', // Add padding between radio button and filename
														]);
														...
														echo '<td style="text-align:center;">' . $predictions->btn_view('admin/predictions/combo_statistics/' . $lottery->id . '/' . $file->file_name) . '</td>';
														echo '<td style="text-align:center;">' . $predictions->btn_trash('admin/predictions/delete/' . $lottery->id . '/' . $file->file_name . '/combo_statistics', $file->file_name) . '</td>';
														echo '</tr>'; ?>
													</div>
												<?php $row++; 
											} ?>

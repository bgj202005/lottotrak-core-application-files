...
<?php if (!is_null($meta_description)) echo '<meta name="description" content="'.$meta_description.' " />'; 
if ($meta_canonical) echo '<link rel="canonical" href="'.($this->uri->segment(1)=='home' ? site_url() : current_url()).'" />'; ?>
<!-- BootstrapCND v4.3 -->
